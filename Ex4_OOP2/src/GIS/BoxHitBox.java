...
public class BoxHitBox {
	...
	private void movePoints(Box box) {
		this.VbotLeft = new Point3D(box.getBotLeft().x()-0.00001,box.getBotLeft().y()-0.00001,0);
		this.VbotRight = new Point3D(box.getBotRight().x()-0.00001,box.getBotRight().y()+0.00001,0);
		this.Vtopleft = new Point3D(box.getTopLeft().x()+0.00001,box.getTopLeft().y()-0.00001,0);
		this.VtopRight = new Point3D(box.getTopRight().x()+0.00001,box.getTopRight().y()+0.00001,0);
